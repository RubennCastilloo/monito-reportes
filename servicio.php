...
<form class="needs-validation formulario-servicios p-4" novalidate>
  ...
  <div class="col-md-4 mb-3">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input id="equipoInput" type="text" class="custom-select " list="equipo" value="">
...
<div class="input-group mb-3">
  ...
  <button class="btn btn-outline-danger" type="submit" id="enviarServicio"><i class="fas fa-check"></i> Enviar Reporte</button>
</form>

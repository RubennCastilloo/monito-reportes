...
?>
<h2 class="text-center pt-3">Crear Usuario</h2>
...
<form class="needs-validation formulario-usuario p-4" novalidate>
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control ingresarNombre" id="usuarioNombre" placeholder="Nombre"  required>
    ...
    <div class="col-md-4 mb-3">
      ...
      <div class="input-group">
        <input type="text" class="form-control ingresarUsuario" id="usuarioUser" placeholder="Usuario" required>
